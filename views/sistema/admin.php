...
<head>
    ...
    <link href="<?=constant('URL')?>https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/plugins/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-1BmE4kWBq78iYhFldvKuhfTAU6auU8tT94WrHftjDbrCEXSU1oBoqyl2QvZ6jIW3" crossorigin="anonymous">
...
<body class="px-4 py-4">
    ...
    <script src="<?=constant('URL')?>https://cdn.jsdelivr.net/npm/bootstrap@5.1.3/plugins/bootstrap/js/bootstrap.bundle.min.js" integrity="sha384-ka7Sk0Gln4gmtz2MlQnikT1wXgYsOg+OMhuP+IlRH9sENBO0LRn5q+8nbTov4+1p" crossorigin="anonymous"></script>
</body>
</html>