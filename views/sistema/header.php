...
<head>
    ...
    <!-- BEGIN VENDOR CSS-->
    <link rel="stylesheet" type="text/css" href="<?= constant('URL') ?>views/sistema/resources/theme-assets/css/vendors.css">
    <link rel="stylesheet" type="text/css" href="<?= constant('URL') ?>views/sistema/resources/theme-assets/vendors/css/charts/chartist.css">
    <!-- END VENDOR CSS-->
    <!-- BEGIN CHAMELEON  CSS-->
    <link rel="stylesheet" type="text/css" href="<?= constant('URL') ?>views/sistema/resources/theme-assets/css/app-lite.css">
    <!-- END CHAMELEON  CSS-->
    <!-- BEGIN Page Level CSS-->
    <link rel="stylesheet" type="text/css" href="<?= constant('URL') ?>views/sistema/resources/theme-assets/css/core/menu/menu-types/vertical-menu.css">
    <link rel="stylesheet" type="text/css" href="<?= constant('URL') ?>views/sistema/resources/theme-assets/css/core/colors/palette-gradient.css">
    <link rel="stylesheet" type="text/css" href="<?= constant('URL') ?>views/sistema/resources/theme-assets/css/pages/dashboard-ecommerce.css">
    <!-- END Page Level CSS-->
    <!-- BEGIN Custom CSS-->
    <!-- END Custom CSS-->
</head>
...
<body class="vertical-layout vertical-menu 2-columns   menu-expanded fixed-navbar" data-open="click" data-menu="vertical-menu" data-color="bg-chartbg" data-col="2-columns">
    ...
    <div class="main-menu menu-fixed menu-light menu-accordion menu-shadow " data-scroll-to-active="true" data-img="<?= constant('URL') ?>views/sistema/resources/theme-assets/images/backgrounds/02.jpg">
        <div class="navbar-header">
            <ul class="nav navbar-nav flex-row">
                <li class="nav-item mr-auto"><a class="navbar-brand" href="<?= constant('URL') ?>sistema"><img class="brand-logo" alt="Paradise_logo" src="<?= constant('URL') ?>views/sistema/resources/theme-assets/images/logo/logo.png" />
                        <h3 class="brand-text" style="font-size: 1.2rem;"><i><b>Paradise Cosmetics</b></i></h3>
                    </a></li>
        ...
        <div class="main-menu-content">
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                <li class="active"><a href="<?= constant('URL') ?>sistema"><i class="ft-home"></i><span class="menu-title" data-i18n="">Dashboard</span></a>
                </li>
                <li class=" nav-item"><a href="charts.html"><i class="ft-pie-chart"></i><span class="menu-title" data-i18n="">Gráficos</span></a>
                </li>
                <li class=" nav-item"><a href="<?= constant('URL') ?>productos/getProducts"><i class="ft-layers"></i><span class="menu-title" data-i18n="">Productos</span></a>
                </li>
                ...
                <li class=" nav-item"><a href="<?= constant('URL') ?>clientes/getClientes"><i class="ft-credit-card"></i><span class="menu-title" data-i18n="">Clientes</span></a>
                </li>
