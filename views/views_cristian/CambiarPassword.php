			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-15 p-b-50">
				<form class="login100-form validate-form">
					...
					<div style="font-family: Arial;" class="wrap-input100 validate-input" data-validate="Nueva Contraseña">
						...
						<input class="input100" type="text" name="name" placeholder="Nueva Contraseña...">
						<span class="focus-input100"></span>
					</div>

					<div class="wrap-input100 validate-input" data-validate = "Contraseña requerida">
						<span class="label-input100">Confirmar Contraseña</span>
						<input class="input100" type="text" name="pass" placeholder="Confirmar Contraseña...">
						<span class="focus-input100"></span>
					</div>
					...
					<div style="position: relative;" class="buy-tickets">
                        <a style="border-color: black;" class="btn dark-purple" href="#">Cambiar Contraseña</a>
                    </div><!-- .buy-tickets -->
				</form>
			</div>
		</div>
