...
<body style="background-color: #999999;">
	...
	<div class="limiter">
		<div class="container-login100">
			...
			<div class="wrap-login100 p-l-50 p-r-50 p-t-15 p-b-50" style="width: 48.5%;">
				<form class="login100-form validate-form">
                        ...
                        <div style="margin-left: auto; margin-right: auto;">
                            <h2 style="font-weight: bold;" class="entry-title">Recuperar Contraseña Paradise Cosmetics</h2>
                        </div>
                        <br>
                        <br>
                        <br>
                    ...
                    <div class="wrap-input100 validate-input" data-validate="Nombres requeridos">
                        ...
                        <input class="input100" type="text" name="name" placeholder="Correo Electronico de Registro...">
                        <span class="focus-input100"></span>
                    </div>
					<div class="buy-tickets" align="center" style="margin-left: 65%;">
						<a style="border-color: black; background-color: black; text-align: center; margin-left: 50%;" href="#" class="btn dark-purple">Enviar</a>
					</div><!-- .buy-tickets -->
					<div class="wrap-input100 validate-input" data-validate="Apellidos requeridos">
						<span class="label-input100">Codigo</span>
						<input class="input100" type="text" name="name" placeholder="Codigo...">
						<span class="focus-input100"></span>
					</div>
                    

					<div class="buy-tickets">
                        <a style="border-color: black; text-align: center; margin-left: 80%;" href="#" class="btn dark-purple">Validar</a>
                    </div><!-- .buy-tickets -->
				</form>
			</div>
		</div>
